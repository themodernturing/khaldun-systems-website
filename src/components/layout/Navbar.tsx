...
const navLinks = [
  ...
  { 
    ...
    path: '/industries',
    items: [
      { name: 'Diagnostic Labs', hash: 'diagnostic-labs', desc: 'Clinical and operational diagnostic intelligence', meta: 'Systems applied: CLINOS, ORBITAL, SIMFORE' },
      { name: 'Finance', hash: 'finance', desc: 'Risk, provisioning, and decision intelligence', meta: 'Systems applied: MAGNUS, SIMFORE, ECL Foresight, ConsolidateAI' },
      { name: 'Education', hash: 'education', desc: 'Learning, assessment, and institutional intelligence', meta: 'Systems applied: AI Seekho, SchoolIQ, MindMatch' },
      { name: 'Legal & Professional Services', hash: 'legal-professional-services', desc: 'Reasoning, compliance, and workflow intelligence', meta: 'Systems applied: LexFlow AI, Tax Law Agent, Legal CRM' },
      { name: 'Climate & Sustainability', hash: 'climate-sustainability', desc: 'Carbon, ESG, and reporting intelligence', meta: 'Systems applied: EmissIQ Carbon, SIMFORE' },
      { name: 'Enterprise Strategy', hash: 'enterprise-strategy', desc: 'Executive decisions, diagnostics, and simulation', meta: 'Systems applied: ORBITAL, MAGNUS, SIMFORE' },
    ]
  },
